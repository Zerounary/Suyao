...
function SuyaoTable (props){
  ...
  return (
    <div className="overflow-x-auto -mx-2 px-2">
      <table
        className="table-auto text-center w-full min-w-[32rem]"
      >
        <thead
        ...
        >
          <tr>
            {
              chart.map(e => {
                let classNames = ["px-2", "sm:px-4", "py-2", "text-sm", "sm:text-base", "whitespace-nowrap"];
                if(e.distance === '命'){
        ...
        >
          <tr>
            {
              chart.map(e => {
                let classNames = ["bg-gray-100", "border", "px-2", "sm:px-4", "py-2", "text-sm", "sm:text-base", "whitespace-nowrap"];
                if(e.secret === '命'){
                  classNames.push('bg-green-600');
          ...
          <tr>
            {
              chart.map(e => {
                let classNames = ["border", "px-2", "sm:px-4", "py-2", "text-sm", "sm:text-base", "whitespace-nowrap", 'bg-green-600'];
                if(e.distance === '命'){
                  classNames.push('bg-green-600');
                  classNames.push('text-gray-100');
                }
